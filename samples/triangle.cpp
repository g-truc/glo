...
void glDraw(GLdevice Device, uint32_t indexCount, uint32_t instanceCount, uint32_t firstIndex, uint32_t vertexOffset, uint32_t firstInstance);
...
{
public:
	command_buffer(VkCommandBuffer CommandBuffer)
	{
...
{
public:
	void submit(command_buffer* CommandBuffer);
...
public:
	...
	void release_command_buffer(command_buffer* CommandBuffer);
